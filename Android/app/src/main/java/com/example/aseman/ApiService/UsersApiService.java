...
public class UsersApiService {
    ...
    public void getAllUsers(final UsersApiService.onAllUsersRecived onAllUsersRecived ){
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0; i<response.length(); i++){
                            ...
                            try {
                                ...
                                user.setId(jsonObject.getInt("user"));
                                ...
                                user.setCity(new City(jsonObject.getInt("city"),"city"));
                                user.setDepartment(new Department(jsonObject.getInt("department"),"department"));
                                users.add(user);
                        ...
                        onAllUsersRecived.onRecived(users);
                    }
    ...
    public interface onAllUsersRecived{
